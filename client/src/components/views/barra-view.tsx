...
export function BarraView() {
  ...
  const cargarPedidos = async () => {
    try {
      ...
      // Filtrar para barra: solo bebidas calientes, frías y postres
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-amber-800">{pendientes.length}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-800">{enPreparacion.length}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-800">{listos.length}</p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-1">
                    {pedido.detalles?.map(detalle => (
                      <div key={detalle.id_detalle} className="flex justify-between text-sm">
                        <span className="font-medium text-[#4C3D19]">
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-blue-700 flex items-center gap-2">
            <ChefHat className="w-5 h-5" /> En Preparación ({enPreparacion.length})
          </h2>
          <div className="space-y-3">
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-green-700 flex items-center gap-2">
            <CheckCircle className="w-5 h-5" /> Listos para Entregar ({listos.length})
          </h2>
          <div className="space-y-3">
            {listos.map(pedido => (
              <Card key={pedido.id_pedido} className="border-green-200 bg-green-50/50">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-green-600 mt-3 text-center">
                    Esperando que el mesero/cajero lo entregue
                  </p>
                </CardContent>
              </Card>
            ))}
