...
export function CocinaView() {
  ...
  if (loading) return <div style={{textAlign:'center', padding:'2rem', color:'var(--caramel)'}}>Cargando pedidos de cocina...</div>
  ...
  return (
    <div className="barra-page">
      ...
      <div className="barra-header">
        ...
        <div>
          <h1 className="barra-title">Cocina</h1>
          <p className="barra-subtitle">Solo Alimentos</p>
        </div>
      </div>
